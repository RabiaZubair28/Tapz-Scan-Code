      ...
      <div className="flex items-center space-x-6 w-full">
        <div className="flex flex-1 items-center justify-center gap-x-3">
          {(!modal04 && !editClientName) && (
            <div className="flex flex-col text-md w-[300px] max-w-[300px] font-semibold text-gray-800 pt-1  text-center gap-y-1">
      ...
      <div className="flex items-center space-x-6 w-full">
        <div className="flex flex-1 items-center justify-center gap-x-3">
          {(!modal03 && !editDesignation) && (
            <div className="flex flex-col text-md w-[300px] max-w-[300px] font-semibold  pt-1  text-center gap-y-1">
      ...
      <div className="flex items-center space-x-6 w-full">
        <div className="flex flex-1 items-center justify-center gap-x-3">
          {(!modal02 && !editDescription) && (
            <div className="flex flex-col text-md w-[280px] max-w-[280px] font-light  pt-1 text-center gap-y-2">
