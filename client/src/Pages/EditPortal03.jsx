...
END:VCARD`;
  ...
  if (client) {
      ...
      <div>
        ...
        {!show && !show02 && !show03 && (
          <section className="main">
            ...
            <div
              className={`min-h-screen w-full px-3 max-w-md mx-auto shadow-lg pt-5 pb-5 text-center bg-gradient-to-b from-[#544e66] to-[#1f153d]`}
              style={{ backgroundAttachment: "fixed" }}
            >
              <div className="px-6">
                {logo && (
              ...
              Delete
                ...
                <div className="px-4">
                  <a
                    ...
                    className="w-full flex items-center justify-center bg-[#4722b4] gap-x-2 border-[0.5px] border-transparent shadow-sm hover:shadow-md hover:bg-gray-100 text-white py-4 mt-2 mb-3 rounded-lg hover:text-black"
                  >
                    <ImWhatsapp
                ...
                <div className="px-4 flex flex-row gap-x-3">
                  ...
                  <a
                    ...
                    className="w-full flex items-center justify-center bg-white  shadow-sm hover:shadow-md hover:bg-gray-100 text-[#1f153d] py-3.5 rounded-lg"
                  >
                    <AiOutlineMail size={20} color="#1f153d" />
                    &nbsp; EMAIL
                  </a>
                </div>
                        ...
                        <div className="flex items-center space-x-6 w-full">
                          <div className="flex flex-1 items-center justify-center gap-x-3">
                            {!modal03 && !editDesignation && (
                              <div className="flex flex-col text-md w-[250px] max-w-[250px] font-semibold  pt-1  text-center gap-y-1">
                                <span className="text-md font-light text-white pt-1 pb-1">
                                  {designation}
                                </span>
                              </div>
                            )}
                ...
                <div className="flex items-center justify-center mt-0 mb-0 px-4">
                  ...
                  <button className="flex w-full gap-x-2 items-center justify-center bg-[#4722b4] border-[0.5px] border-transparent shadow-sm hover:shadow-md hover:bg-gray-100 text-white py-4 mt-2 mb-3 rounded-lg hover:text-black">
                    ...
                    <span
                      ...
                      className=" text-wite hover:text-black"
                      onClick={downloadContactCard}
                    >
                      &nbsp;SAVE CONTACT
                    </span>
                          ...
                          <div className="flex flex-1 items-center justify-center gap-x-3">
                            {!modal02 && !editDescription && (
                              <div className="flex flex-col text-md w-[230px] max-w-[230px] font-light  pt-1 text-center gap-y-2">
                                <span className="text-sm text-white pb-1 max-w-[280px] break-words">
                                  {description}
                                </span>
                              </div>
                            )}
        ...
        {show02 && (
          <div
            className="min-h-screen bg-gradient-to-b from-[#544e66] to-[#1f153d]  w-full max-w-md mx-auto shadow-lg flex flex-col items-center justify-center relative"
            style={{ backgroundAttachment: "fixed" }}
          >
            <div className="bg-white border-gray-500 rounded-lg pb-8 pt-16 px-10 relative">
              {/* Close Icon */}
    ...
    return (
      <div
        className={`min-h-screen w-full max-w-md mx-auto shadow-lg pb-5 text-center flex justify-center align-center bg-gradient-to-b from-[#544e66] to-[#1f153d] pt-[30%]`}
        style={{ backgroundAttachment: "fixed" }}
      >
        <ScaleLoader
          color={"white"}
