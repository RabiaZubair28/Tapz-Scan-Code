        ...
        {!show && !show02 && (
          ...
          <p>{visitCount}</p>
                ...
                <div className="flex flex-col justify-center items-start">
                  <p className="text-sm text-left text-gray-800 pt-1 pb-1 w-full  break-words">
                    {description}
                  </p>
                </div>
                ...
                {phone01 && (
                  <div className="flex justify-center mt-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-5 py-3 bg-white hover:bg-gray-50 text-gray-800 border-[0.25px] border-white shadow rounded-lg max-w-md"
                    >
                ...
                {telephone02 && (
                  <div className="flex justify-center mt-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-5 py- bg-white hover:bg-gray-50 text-gray-800 border-[0.25px] border-white shadow rounded-lg max-w-md"
                    >
                      <div className="flex items-center space-x-6">
                        <img
                          src={telephone}
                ...
                {address && (
                  <div className="flex justify-center mt-3">
                    <button className="flex items-center justify-between w-full px-5 py-3  bg-white hover:bg-gray-50 text-gray-800 border-[0.25px] border-white shadow rounded-lg max-w-md">
                      <div className="flex items-center space-x-6">
                        <img
                          src={addressImg}
                          alt="Address"
              ...
              {services != "" && (
                <div className="px-4 ">
                  ...
                  {services && (
                    <div className="flex justify-center mt-2 w-full px-5 py-3 bg  bg-white hover:bg-gray-50 text-gray-800 border-[0.25px] border-white shadow rounded-lg max-w-md">
