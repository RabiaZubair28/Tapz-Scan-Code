        ...
        {!show && !show02 && (
            ...
            >
              ...
              <div className="px-6">
                <div className="flex flex-col justify-center items-start pt-0.5">
                  ...
                  <h2 className="text-2xl font-semibold text-black pt-1">
                    {clientName}
                  </h2>
          ...
          <p>{visitCount}</p>
                ...
                <div className="flex justify-between ">
                  <div className="flex justify-start space-x-5 mt-3 mb-2.5">
                    <a
                      ...
                      className="w-12 h-12 flex items-center  bg-[#bdbdbd] border-black justify-center rounded-full bg-gray-7 border-[0.25px] shadow-sm hover:shadow-md "
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 flex items-center justify-center rounded-full  bg-[#bdbdbd] border-black border-[0.25px] shadow-sm hover:shadow-md "
                    >
                ...
                <div className="flex flex-col justify-center items-start">
                  <p className="text-sm text-left text-black pt-1 pb-1 w-full  break-words">
                    {description}
                  </p>
                </div>
                ...
                {telephone02 && (
                  <div className="flex justify-center mt-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-5 py-3 bg-[#bdbdbd] text-black border-[0.25px] border-black shadow rounded-lg max-w-md"
                    >
                ...
                {menuLink && (
                  <div className="flex justify-center mt-3">
                    <button
                      className="flex items-center justify-between w-full px-5 py-3 bg-[#bdbdbd] text-black border-[0.25px] rounded-lg border-black shadow  max-w-md"
              ...
              {services != "" && (
                <div className="px-4 ">
                  ...
                  {services && (
                    <div className="flex justify-center mt-2 w-full px-5 py-3 bg-[#bdbdbd] text-black border-[0.25px] border-black shadow rounded-lg max-w-md">
              ...
              <div className="px-4">
                ...
                <div className="flex justify-center space-x-3 mt-3 px-4">
                  <div
                    className=" flex justify-center items-center w-16 h-16 rounded-full border-[0.25px] border-black bg-[#bdbdbd] hover:border-white"
                    onClick={handleShow}
                  >
