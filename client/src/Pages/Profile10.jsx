        ...
        {!show && !show02 && (
            ...
            >
              ...
              <div className="px-6">
                <div className="flex flex-col justify-center items-start pt-0.5">
                  <h2 className="text-lg font-semibold text-[#C79D3D] pt-1 ">
                    {name}
                  </h2>
                  <h2 className="text-2xl font-semibold text-[#C79D3D] pt-1">
                    {clientName}
                  </h2>
                  <p className="text-md font-semibold text-[#C79D3D] pt-1 pb-1">
                    {designation}
                  </p>
                </div>
          ...
          <p>{visitCount}</p>
                ...
                <div className="flex justify-between ">
                  ...
                  <div className="flex items-center justify-end mt-3 mb-2.5 gap-x-4">
                    <div className="flex justify-start gap-x-2  pb-1 items-center">
                      ...
                      <p className="text-[#C79D3D]">{visitCount}</p>
                    </div>
                    <button className="flex items-start justify-start  gap-x-2 rounded-lg py-2.5  px-4 bg-gray-600 hover:bg-gray-500 border-white bg-gray-7 border-[0.25px] shadow-sm hover:shadow-md text-[#C79D3D]">
                ...
                <div className="flex flex-col justify-center items-start">
                  <p className="text-sm text-left text-[#C79D3D] pt-1 pb-1 w-full  break-words">
                    {description}
                  </p>
                </div>
                ...
                {telephone02 && (
                  <div className="flex justify-center mt-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-5 py- bg-gray-600 hover:bg-gray-500 text-[#C79D3D] border-[0.25px] border-white shadow rounded-lg max-w-md"
                    >
                ...
                {telephone01 && (
                  <div className="flex justify-center mt-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-5 py-3  bg-gray-600 hover:bg-gray-500 text-[#C79D3D] border-[0.25px] border-white shadow rounded-lg max-w-md"
                    >
                      <div className="flex items-center space-x-6">
                        <img
                          src={telephone}
                ...
                {menuLink && (
                  <div className="flex justify-center mt-3">
                    <button
                      className="flex items-center justify-between w-full px-5 py-3  bg-gray-600 hover:bg-gray-500 text-[#C79D3D] border-[0.25px] rounded-lg border-white shadow  max-w-md"
              ...
              {services != "" && (
                <div className="px-4 ">
                  <h2 className="text-xl font-semibold text-[#C79D3D] mb-3 mt-5">
                    Services
                  </h2>
                  <hr className="border-gray-300" />
                  {services && (
                    <div className="flex justify-center mt-2 w-full px-5 py-3 bg  bg-gray-600 hover:bg-gray-500 text-[#C79D3D] border-[0.25px] border-white shadow rounded-lg max-w-md">
                      <a className="flex w-full py-1  text-gray-700  max-w-md">
                        <div className="flex items-center space-x-6 w-full">
                          <div className="flex flex-row w-full  items-start justify-between gap-x-3">
                            <div className="flex flex-col text-md max-w-[250px] font-medium text-[#C79D3D] pt-1 text-start gap-y-1">
                              {services.split("\n").map((line, index) => (
                                <div
                                  key={index}
                                  className="flex items-start space-x-2"
                                >
                                  <span className="text-[#C79D3D]">•</span>
                                  <span>{line}</span>
                                </div>
                              ))}
                            </div>
              ...
              <div className="px-4">
                <h2 className="text-xl font-semibold text-[#C79D3D] mb-3 mt-5 px-4">
                  Share Contact & QR
                </h2>
                <hr className="border-gray-300" />
