...
END:VCARD`;
  ...
  if (client) {
      ...
      <div>
        ...
        {!show && !show02 && (
          <section className="main">
            ...
            <div
              className={`min-h-screen w-full max-w-md mx-auto shadow-lg pt-5 pb-5 text-center bg-gradient-to-b from-[#544e66] to-[#1f153d]`}
              style={{ backgroundAttachment: "fixed" }}
            >
              <div className="px-6">
                {logo && (
                ...
                <div className="px-4">
                  <a
                    ...
                    className="w-full flex items-center justify-center bg-[#4722b4] gap-x-2 border-[0.5px] border-transparent shadow-sm hover:shadow-md hover:bg-gray-100 text-white hover:text-black py-4 mt-2 mb-3 rounded-lg"
                  >
                    <ImWhatsapp
                      size={20}
                      color="white"
                ...
                <div className="flex flex-col justify-center items-center">
                  {name != "" && (
                    <h2 className="text-lg font-light text-white pt-4 ">
                      {name}
                    </h2>
                  )}
                  {clientName != "" && (
                    <h2 className="text-3xl font-semibold text-white pt-1">
                      {clientName}
                    </h2>
                  )}
                  {designation != "" && (
                ...
                <div className="flex flex-col justify-center items-center">
                  <p className="text-sm text-white pb-1 max-w-[280px] break-words">
                    {description}
                  </p>
                </div>
                ...
                {address && (
                  <div className="flex justify-center mt-3">
                    <button className="flex items-center justify-between w-full px-5 py-3 bg-white text-gray-700 shadow rounded-lg max-w-md">
                      <div className="flex items-center space-x-6">
                        <img
                          src={addressImg}
                          alt="Address"
    ...
    return (
      <div
        className={`min-h-screen w-full max-w-md mx-auto shadow-lg pb-5 text-center flex justify-center align-center bg-gradient-to-b from-[#544e66] to-[#1f153d] pt-[25%]`}
        style={{ backgroundAttachment: "fixed" }}
      >
        <ScaleLoader
          color={"white"}
