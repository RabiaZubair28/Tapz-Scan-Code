...
const Profile33 = () => {
  ...
  const renderActionCard = ({ value, href, title, subtitle, icon }, index) => {
    if (!isFilled(value) || !isFilled(href)) return null;
                  ...
                  <a href={logo}>
                    <div className="relative mb-2 ">
                      <img
                        src={logo}
                        alt="profile"
                        className="w-48 h-48 mt-5 mx-auto rounded-full border-[3px] border-[var(--profile-theme-color)] shadow-md"
                      />
                    </div>
                  </a>
                </div>
              ...
              <div className="px-5">
                ...
                {(img01 != "" ||
                  ...
                  <div className="px-0">
                    ...
                    {img01 && (
                      <div className="flex flex-col items-center bg-[var(--profile-theme-color)] mx-auto rounded-xs border-[2px] border-[var(--profile-theme-color)] shadow-md space-y-2 mt-3">
                        <a href={img01}>
                          <img
                            src={img01}
                            alt="Image"
