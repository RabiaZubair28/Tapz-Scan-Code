...
END:VCARD`;
  ...
  const handleEditYoutubeShorts = async (id) => {
    ...
    var newYoutubeShortsText =
      document.getElementById("youtubeShortsText").value;
  ...
  const handleEditGoogleReview02 = async (id) => {
    ...
    var newGoogleReviewText02 =
      document.getElementById("googleReviewText02").value;
  ...
  const handleEditGoogleReview03 = async (id) => {
    ...
    var newGoogleReviewText03 =
      document.getElementById("googleReviewText03").value;
  ...
  if (client) {
    return (
      <div>
        {show && (
          <div
            className="qr-modal min-h-screen w-full max-w-md mx-auto shadow-lg flex flex-col items-center justify-center relative bg-[#C79D3D]"
            style={{ backgroundAttachment: "fixed", backgroundColor: "#d4a84e", backgroundImage: cardGoldGradient }}
          >
            <div className="bg-white border-black rounded-lg pb-8 pt-16 px-10 relative">
              {/* Close Icon */}
              <ImCross
              ...
              <div className="flex flex-col items-center justify-center space-y-8">
                ...
                <div className="flex justify-center space-x-2">
                  <div
                    className="w-12 h-12 bg-white text-black p-3 rounded-full hover:bg-white flex items-center justify-center"
                    onClick={() => {
                      downloadQr("qr");
                      handleClose();
                    }}
                  ...
                  <a href={images} className="w-full">
                    <div className="relative mb-2 ">
                      <img
                        src={images}
                        alt="profile"
                        className="mx-auto h-[220px] w-full object-cover border-b-[1px] border-black"
                      />
                    </div>
                  </a>
                </div>
              ...
              {logo && (
                <div className="flex  flex-row items-start  justify-between mx-auto rounded-x ps-6 pe-4 space-y-2 mt-4">
                  <a href={logo}>
                    <div className="relative mb-2 ">
                      <img
                        src={logo}
                        alt="profile"
                        className="w-24 h-24 object-cover -mt-16 mx-auto rounded-2xl border-[1px] border-black bg-white shadow-lg"
                      />
                    </div>
                  </a>
                  ...
                  <span style={{display:"flex",alignItems:"center",justifyContent:"center",
                    ...
                    <button className="flex items-start justify-start -mt-5 gap-x-2 rounded-lg py-2.5  px-3 bg-white border text-sm border-black shadow-sm hover:shadow-md hover:bg-white">
              ...
              <div className="px-6">
                <div className="flex flex-col justify-center items-start pt-0.5">
                      ...
                      <a className="flex w-full pe-5 py-1 text-lg font-semibold text-black max-w-md">
                        <div className="flex items-start space-x-6 w-full">
                          <div className="flex flex-1 items-start justify-center gap-x-3">
                            {!modal05 && !editName && (
                              <div className="flex flex-col text-lg w-[280px] max-w-[280px] font-semibold text-black text-start gap-y-1">
                            ...
                            {modal05 && (
                              <div className="text-start w-full">
                                ...
                                <div className="flex justify-start space-x-1">
                                  <button
                                    className="bg-black font-medium text-md text-white px-3 py-1 rounded-md border border-black"
                  ...
                  {clientName && (
                    <div className="flex justify-center">
                      <a className="flex w-full pe-5 py-1  text-black  max-w-md">
                        <div className="flex items-start space-x-6 w-full">
                          <div className="flex flex-1 items-start justify-center gap-x-3">
                            {!modal04 && !editClientName && (
                              <div className="flex flex-col text-md w-[280px] max-w-[280px] font-semibold text-black text-start gap-y-1">
                        ...
                        <div className="flex items-center space-x-6 w-full">
                          <div className="flex flex-1 items-start justify-center gap-x-3">
                            {!modal03 && !editDesignation && (
                              <div className="flex flex-col text-md w-[280px] max-w-[280px] font-semibold text-black pt-1  text-start gap-y-1">
                                <span className="text-md text-black fontsemibold pb-1">
                                  {designation}
                                </span>
                              </div>
                            )}
                  ...
                  <div className="flex justify-start space-x-5 mt-2 mb-2.5">
                    <a
                      ...
                      className="w-12 h-12 flex items-center bg-white hover:bg-white border-black justify-center rounded-full bg-gray-7 border-[0.25px] shadow-sm hover:shadow-md"
                    >
                        ...
                        <div className="flex items-start space-x-6 w-full">
                          <div className="flex flex-1 items-start justify-center gap-x-3">
                            {!modal02 && !editDescription && (
                              <div className="flex flex-col text-md w-[280px] max-w-[280px] font-light text-black pt-1 text-start gap-y-1">
                                <span className="text-sm text-black pt-1 pb-1  break-words whitespace-pre-line">
                                  {description}
                                </span>
                              </div>
                            )}
                ...
                {phone01 && (
                  <div className="flex justify-center mt-3">
                    <a className="flex w-full px-5 py-3 border-[0.25px] border-black  bg-white hover:bg-white hover:border-black text-black shadow rounded-lg max-w-md">
                      {/* Phone Icon and Info */}
                      <div className="flex items-center space-x-6 w-full">
                ...
                {email && (
                  <div className="flex justify-center mt-3 ">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-5 py-3 border-[0.25px] border-black  bg-white hover:bg-white hover:border-black text-black shadow rounded-lg max-w-md"
                    >
                ...
                {(phone01 == "" ||
                  ...
                  profileLink02 == "") && (
                  <div
                    className="flex items-center  cursor-pointer border-[0.25px] border-black  bg-white hover:bg-white hover:border-black text-black mx-auto rounded-lg shadow-md px-4 py-2 mt-3 gap-x-2"
              ...
              <div className="px-4">
                {services != "" && (
                  <div className="">
                    ...
                    {services && (
                      <div className="flex justify-center mt-2 w-full px-5 py-3 bg-white text-black shadow rounded-lg max-w-md border-[0.25px] border-black">
                ...
                <div className="">
                  ...
                  <hr className="border-black" />
                  {img01 && (
                    <div className="flex flex-col items-center bg-white mx-auto rounded-xl border-[0.25px] border-black shadow-md space-y-2 mt-3 pb-2">
                      <a href={img01}>
                        <img
                          src={img01}
                          alt="Image"
                      ...
                      {deleteModal01 && (
                        <div>
                          ...
                          <div className="flex items-center justify-center mt-1 space-x-1">
                            <button
                              className="bg-black text-white py-1 px-4 border border-black rounded-md hover:bg-white"
                              onClick={() => {
                                setDeleteModal01(false);
                              }}
                            >
                            ...
                            <button
                              className="bg-black text-white py-1 px-3 border border-black rounded-md hover:bg-white"
                              onClick={() => {
                  ...
                  {(img01 == "" ||
                    ...
                    >
                      <IoIosAddCircle className="text-black mt-2" size={30} />
                ...
                {location != "" && (
                  <div className="">
                    ...
                    <hr className="border-black" />
                    <div className="flex flex-col items-center bg-white mx-auto rounded-xl border-4 border-black shadow-md  space-y-4 mt-3">
                      {location && (
                        <iframe
                          src={location}
                          width="100%"
                ...
                <div className="flex justify-center space-x-3 mt-3 px-4">
                  <div
                    className=" flex justify-center items-center w-16 h-16 rounded-full border-2 border-black bg-white"
                    onClick={handleShow}
                  >
        ...
        {show02 && (
          <div
            className="min-h-screen bg-[#C79D3D] w-full max-w-md mx-auto shadow-lg flex flex-col items-center justify-center relative"
            style={{ backgroundAttachment: "fixed", backgroundColor: "#d4a84e", backgroundImage: cardGoldGradient }}
          >
            <div className="bg-white border-black rounded-lg pb-8 pt-16 px-10 relative">
              {/* Close Icon */}
                      ...
                      <div className="flex flex-col justify-center">
                        {selected02 != "" && (
                          <div>
                            ...
                            >
                              <input
                                className="px-3 py-0.5 border border-black rounded-md focus:outline-none"
                                id="add-link-text"
                                style={{
                                  paddingBlock: "5px",
                                  width: "200px",
        ...
        {show03 && (
          <div
            className="qr-modal min-h-screen bg-[#C79D3D] w-full max-w-md mx-auto shadow-lg flex flex-col items-center justify-center relative"
            style={{ backgroundAttachment: "fixed", backgroundColor: "#d4a84e", backgroundImage: cardGoldGradient }}
          >
            <div className="bg-white border-black rounded-lg pb-8 pt-16 px-10 relative">
              {/* Close Icon */}
    ...
    return (
      <div
        className={`min-h-screen w-full max-w-md mx-auto shadow-lg pb-5 text-center flex justify-center align-center bg-[#C79D3D] pt-[25%]`}
        style={{ backgroundAttachment: "fixed", backgroundColor: "#d4a84e", backgroundImage: cardGoldGradient }}
      >
        <ScaleLoader
          color={"black"}
