        ...
        <div>
          {show && (
            ...
            >
              <div className="bg-white border-gray-500 rounded-lg pb-8 pt-16 px-10 relative">
                {/* Close Icon */}
                <ImCross
                  className="absolute top-4 right-4 cursor-pointer text-[#784330]"
                  onClick={handleClose}
                />
                ...
                <div className="flex flex-col items-center justify-center space-y-8">
                  ...
                  <div className="flex justify-center space-x-2">
                    <div
                      className="w-12 h-12 bg-[#784330] text-white p-3 rounded-full flex items-center justify-center"
                      onClick={() => {
                        downloadQr("qr");
                        handleClose();
                      }}
          ...
          {!show && !show02 && (
            ...
            ()=>{
              ...
              <div
                className={`min-h-screen w-full max-w-md mx-auto shadow-lg pb-5 text-center bg-gradient-to-tr from-[#784330] via-[#764a3a] to-[#957a71] pt-4`}
                style={{ backgroundAttachment: "fixed" }}
              >
                {logo && (
                  <div className="flex  flex-row items-center  justify-between mx-auto rounded-x ps-6 pe-4 space-y-2 mt-4">
                    ...
                    <div className="flex items-center justify-center -mt-24 mb-5 gap-x-2">
                      <div className="flex justify-center gap-x-1  pb-1 items-center">
                        <MdRemoveRedEye size={20} color="white" />
                        <p className="text-white">{visitCount}</p>
                      </div>
                      <button className="flex items-start justify-start gap-x-2 rounded-lg py-2.5  px-3 text-sm  bg-white border border-white shadow-sm hover:shadow-md hover:bg-white">
          ...
          <p>{visitCount}</p>
                  ...
                  {address && (
                    <div className="flex justify-center mt-3">
                      <button className="flex items-center justify-between w-full px-5 py-3 bg-white  text-[#784330] border-[0.25px] border-white shadow rounded-lg max-w-md">
                        <div className="flex items-center space-x-6">
                          <img
                            src={addressImg}
                            alt="Address"
                ...
                {services != "" && (
                  <div className="px-4 ">
                    ...
                    {services && (
                      <div className="flex justify-center mt-2 w-full px-5 py-3 bg bg-white  text-[#784330] border-[0.25px] border-white shadow rounded-lg max-w-md">
