            ...
            ()=>{
              ...
              >
                <div className="px-6 ">
                  ...
                  {whatsapp01 && (
                    <div className="flex justify-center mt-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between w-full px-5 py-3 border-4 border-[#C79D3D] bg-white text-gray-700 shadow rounded-lg max-w-md"
                      >
                  ...
                  {telephone02 && (
                    <div className="flex justify-center mt-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between w-full px-5  py-3 bg-white text-gray-700 shadow rounded-lg max-w-md border-4 border-[#C79D3D]"
                      >
                        <div className="flex items-center space-x-6">
                          <img
                            src={telephone}
                  ...
                  {address && (
                    <div className="flex justify-center mt-3">
                      <button className="flex items-center justify-between w-full px-5 py-3 bg-white text-gray-700 shadow rounded-lg max-w-md border-4 border-[#C79D3D]">
                        <div className="flex items-center space-x-6">
                          <img
                            src={addressImg}
                            alt="Address"
