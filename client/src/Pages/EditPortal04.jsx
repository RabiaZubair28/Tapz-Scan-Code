...
{show && (
      <div
      className="qr-modal min-h-screen w-full max-w-md mx-auto shadow-lg flex flex-col items-center justify-center relative bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800" style={{ backgroundAttachment: "fixed" }}
    >
      ...
      <div className="flex flex-col justify-start items-start mx-auto rounded-x px-6 space-y-2 mt-3">
        ...
        {!editCover && (
          <div className="space-x-2">
            <button
              className="btn bg-green-500 text-white rounded-md py-1 px-6"
              onClick={() => {setDeleteModal12(false)
                setEditCover(true)}}
            >
              Edit Cover
            </button>
    ...
    <a className="flex w-full pe-5 py-1  text-white  max-w-md">
      <div className="flex items-center space-x-6 w-full">
        <div className="flex flex-1 items-start justify-center gap-x-3">
          {(!modal03 && !editDesignation) && (
            <div className="flex flex-col text-md w-[250px] max-w-[250px] font-semibold text-white pt-1  text-start gap-y-1">
              <span className="text-md text-white fontsemibold pb-1">{designation}</span>
            </div>
          )}
          {(!modal03 && !editDesignation) && (
        ...
        rel="noopener noreferrer" className="w-12 h-12 flex items-center bg-gray-600 hover:bg-gray-500 border-white justify-center rounded-full bg-gray-7 border-[0.25px] shadow-sm hover:shadow-md">
            ...
            <a href={`sms:${phone01}`} className="w-12 h-12 flex items-center bg-gray-600 hover:bg-gray-500 border-white justify-center rounded-full bg-gray-7 border-[0.25px] shadow-sm hover:shadow-md">
      ...
      <div className="flex items-start space-x-6 w-full">
        <div className="flex flex-1 items-start justify-center gap-x-3">
          {(!modal02 && !editDescription) && (
            ...
            <span className="text-sm text-white pt-1 pb-1  break-words">{description}</span>
          </div>
      ...
      <div className="flex items-center space-x-6 w-full">
        ...
        <div className="flex flex-1 items-center justify-between">
          ...
          {!modal12 && !editEmail02 && (
            ...
            <span className="font-medium">Email</span>
            <span className=" max-w-[160px] text-sm break-words">{email02}</span>
          </div>
      ...
      <div className="flex items-center space-x-6 w-full">
        ...
        <div className="flex flex-1 items-center justify-between">
          ...
          {!modal13 && !editEmail03 && (
            <div className="flex flex-col max-w-[160px] text-start gap-y-1">
            <span className="font-medium">Email</span>
            <span className=" max-w-[160px] text-sm break-words">{email03}</span>
          </div>
...
{img02 && (<div className="flex flex-col items-center bg-gray-600 mx-auto rounded-xl border-[0.25px] border-white shadow-md space-y-2 mt-3 pb-2">
      <a href={img02}>
        <img
          src={img02}
          alt="Image"
...
{img03 && (<div className="flex flex-col items-center bg-gray-600 mx-auto rounded-xl border-[0.25px] border-white shadow-md space-y-2 mt-3 pb-2">
      <a href={img03}>
        <img
          src={img03}
          alt="Image"
...
{img04 && ( <div className="flex flex-col items-center bg-gray-600 mx-auto rounded-xl border-[0.25px] border-white shadow-md space-y-2 mt-3 pb-2">
      <a href={img04}>
        <img
          src={img04}
          alt="Image"
    ...
    {img05 && ( <div className="flex flex-col items-center bg-gray-600 mx-auto rounded-xl border-[0.25px] border-white shadow-md space-y-2 mt-3 pb-2">
      <a href={img05}>
        <img
          src={img05}
          alt="Image"
    ...
    {img06 && ( <div className="flex flex-col items-center bg-gray-600 mx-auto rounded-xl border-[0.25px] border-white shadow-md space-y-2 mt-3 pb-2">
      <a href={img06}>
        <img
          src={img06}
          alt="Image"
...
>
  ...
  <div className="text-lg font-bold text-white">Add More Images</div>
</div>}
