/* EditPortal36: EditPortal04 functionality styled to match Profile36 black/gold template. */
...
END:VCARD`;
  ...
  const cardGoldGradient =
    "linear-gradient(180deg, #000000 0%, #060606 55%, #000000 100%)";
    ...
    return (
      <div>
        {show && (
          ...
          >
            <div className="bg-white border-[2px] border-[#fef485] rounded-lg pb-8 pt-16 px-10 relative">
              {/* Close Icon */}
              <ImCross
                className="absolute top-4 right-4 cursor-pointer text-[#fef485] hover:text-black"
                onClick={handleClose}
              />
              ...
              <div className="flex flex-col items-center justify-center space-y-8">
                ...
                <div className="flex justify-center space-x-2">
                  <div
                    className="w-12 h-12 bg-black text-white p-3 rounded-full hover:bg-[#181818] flex items-center justify-center"
                    onClick={() => {
                      downloadQr("qr");
                      handleClose();
                    }}
                  ...
                  <div className="social-btn">
                    ...
                    >
                      <img
                        ...
                        alt="Facebook"
                        className="w-12 h-12 rounded-full border-2 border-[#fef485]"
                      />
                    </FacebookShareButton>
                  </div>
                  ...
                  <a href={images} className="w-full">
                    <div className="relative mb-2 ">
                      <img
                        src={images}
                        alt="profile"
                        className="mx-auto  h-[220px] w-full bg-cover border-b-[3px] border-[#fef485]"
                      />
                    </div>
                  </a>
                </div>
              ...
              {logo && (
                <div className="flex  flex-row items-start  justify-between mx-auto rounded-x ps-6 pe-4 space-y-2 mt-4">
                  <a href={logo}>
                    <div className="relative mb-2 ">
                      <img
                        src={logo}
                        alt="profile"
                        className="w-36 h-36 -mt-24 mx-auto rounded-2xl border-[3px] border-[#fef485] bg-black shadow-lg"
                      />
                    </div>
                  </a>
                  ...
                  <span style={{display:"flex",alignItems:"center",justifyContent:"center",
                    ...
                    <button className="flex items-start justify-start -mt-5 gap-x-2 rounded-lg py-2.5  px-3 bg-black border text-sm border-[#fef485] shadow-sm hover:shadow-md hover:bg-[#181818]">
              ...
              <div className="flex flex-col justify-start items-start mx-auto rounded-x px-6 space-y-2 mt-3">
                {!editLogo && (
                  <div className="space-x-2">
                    <button
                      className="btn bg-[#fef485] text-black rounded-md py-1 px-6"
                      onClick={() => {
                    ...
                    {/* <button
              className="btn bg-black text-white border border-[#fef485] rounded-md py-1 px-4"
              onClick={() => {
              ...
              <div className="px-6">
                <div className="flex flex-col justify-center items-start pt-0.5">
                            ...
                            {modal05 && (
                              <div className="text-start w-full">
                                ...
                                <div className="flex justify-start space-x-1">
                                  <button
                                    className="bg-black font-medium text-md text-white px-3 py-1 rounded-md border border-[#fef485]"
                            ...
                            {editName && (
                              <div className="flex flex-col text-start gap-y-1 w-full">
                                ...
                                <div className="flex items-center space-x-2 mt-1">
                                  ...
                                  <button
                                    className="bg-[#fef485] text-black px-2 py-1 rounded-md text-sm"
                                    onClick={() => {
                                      handleEditName(_id);
                                      setEditName(false);
                                      window.location.reload();
                                  ...
                                  <button
                                    className="bg-black text-white border border-[#fef485] px-2 py-1 rounded-md text-sm"
                  ...
                  {clientName && (
                    <div className="flex justify-center">
                      <a className="flex w-full pe-5 py-1  text-white  max-w-md">
                        <div className="flex items-start space-x-6 w-full">
                          <div className="flex flex-1 items-start justify-center gap-x-3">
                  ...
                  <div className="flex justify-start space-x-5 mt-2 mb-2.5">
                    <a
                      ...
                      className="w-12 h-12 flex items-center bg-black hover:bg-[#181818] border-[#fef485] justify-center rounded-full bg-gray-7 border-[0.25px] shadow-sm hover:shadow-md"
                    >
                ...
                {phone01 && (
                  <div className="flex justify-center mt-3">
                    <a className="flex w-full px-5 py-3 border-[0.25px] border-[#fef485]  bg-black hover:bg-[#181818] hover:border-[#fef485] text-white shadow rounded-lg max-w-md">
                      {/* Phone Icon and Info */}
                      <div className="flex items-center space-x-6 w-full">
                ...
                {email && (
                  <div className="flex justify-center mt-3 ">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-5 py-3 border-[0.25px] border-[#fef485]  bg-black hover:bg-[#181818] hover:border-[#fef485] text-white shadow rounded-lg max-w-md"
                    >
                ...
                {(phone01 == "" ||
                  ...
                  profileLink02 == "") && (
                  <div
                    className="flex items-center  cursor-pointer border-[0.25px] border-[#fef485]  bg-black hover:bg-[#181818] hover:border-[#fef485] text-white mx-auto rounded-lg shadow-md px-4 py-2 mt-3 gap-x-2"
              ...
              <div className="px-4">
                {services != "" && (
                  <div className="">
                    ...
                    <hr className="border-[#fef485]" />
                    {services && (
                      <div className="flex justify-center mt-2 w-full px-5 py-3 bg-black text-white shadow rounded-lg max-w-md border-[0.25px] border-[#fef485]">
                ...
                <div className="">
                  ...
                  <hr className="border-[#fef485]" />
                  {img01 && (
                    <div className="flex flex-col items-center bg-black mx-auto rounded-xl border-[0.25px] border-[#fef485] shadow-md space-y-2 mt-3 pb-2">
                      <a href={img01}>
                        <img
                          src={img01}
                          alt="Image"
                      ...
                      {deleteModal01 && (
                        <div>
                          ...
                          <div className="flex items-center justify-center mt-1 space-x-1">
                            <button
                              className="bg-black text-white py-1 px-4 border border-[#fef485] rounded-md hover:bg-black"
                              onClick={() => {
                                setDeleteModal01(false);
                              }}
                            >
                            ...
                            <button
                              className="bg-black text-white py-1 px-3 border border-[#fef485] rounded-md hover:bg-black"
                              onClick={() => {
                  ...
                  {(img01 == "" ||
                    ...
                    img10 == "") && (
                    <div
                      className="flex items-center  cursor-pointer mt-3   px-3 pt-1 pb-3 gap-x-2 bg-black   mx-auto rounded-xl border-[0.25px] shadow-md space-y-3"
                ...
                {location != "" && (
                  <div className="">
                    ...
                    <hr className="border-[#fef485]" />
                    <div className="flex flex-col items-center bg-white mx-auto rounded-xl border-[3px] border-[#fef485] shadow-md  space-y-4 mt-3">
                      {location && (
                        <iframe
                          src={location}
                          width="100%"
                ...
                <div className="flex justify-center space-x-3 mt-3 px-4">
                  <div
                    className=" flex justify-center items-center w-16 h-16 rounded-full border-2 border-[#fef485] bg-white"
                    onClick={handleShow}
                  >
                      ...
                      <div className="flex flex-col justify-center">
                        {selected02 != "" && (
                          <div>
                            ...
                            >
                              <input
                                className="px-3 py-0.5 border border-[#fef485] rounded-md focus:outline-none"
                                id="add-link-text"
                                style={{
                                  paddingBlock: "5px",
                                  width: "200px",
