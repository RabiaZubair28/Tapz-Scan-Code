...
>
  ...
  { !show && !show02 &&
    ...
    <div className={`min-h-screen w-full px-3 max-w-md mx-auto shadow-lg pt-5 pb-5 text-center bg-gradient-to-tr from-[#16215c] via-[#16215c] to-[#16215c]`} style={{ backgroundAttachment: "fixed" }}>
      ...
      <h2 className="text-2xl font-semibold font-serif text-gray-800 pt-1">{romanName}</h2>
      <p className="text-md font-semibold text-gray-900 pt-1 pb-1 break-words">{designation}</p>
