...
>
  ...
  { !show && !show02 &&
    ...
    <div className={`min-h-screen w-full px-3 max-w-md mx-auto shadow-lg pt-5 pb-5 text-center bg-gradient-to-tr from-[#16215c] via-[#16215c] to-[#16215c]`} style={{ backgroundAttachment: "fixed" }}>
      ...
      <h2 className="text-xl font-semibold font-serif text-gray-800 pt-1">{romanName}</h2>
      <p className="text-md font-semibold text-gray-900 pt-1 pb-1 break-words  whitespace-pre-wrap">{designation}</p>
      <p className="text-sm text-gray-900 pt-1 pb-1 max-w-[320px] break-words">{description}</p></div>
 ...
 {(location != "") && <div className="px-4">
    ...
    {/* <iframe src={details[i].location} width="600" height="450" allowfullscreen="" loading="lazy"></iframe> */}
        ...
        return(
            ...
            <div className={`min-h-screen w-full max-w-md mx-auto shadow-lg pb-5 text-center flex justify-center align-center bg-gradient-to-tr from-[#16215c] via-[#16215c] to-[#16215c] pt-[25%]`} style={{ backgroundAttachment: "fixed" }}>
            <ScaleLoader
            color={"white"}
            size={50}
