      ...
      <section>
        ...
        <div>
              ...
              <div className="bg-white border-gray-500 rounded-lg pb-8 pt-16 px-10 relative">
                ...
                <div className="flex flex-col items-center justify-center space-y-8">
                  ...
                  <div className="flex justify-center space-x-2">
                    <div
                      className="w-12 h-12 bg-[#38572e] text-white p-3 rounded-full hover:bg-[#38572e]  flex items-center justify-center"
                      onClick={() => {
                        downloadQr("qr");
                        handleClose();
                      }}
          ...
          <p>{visitCount}</p>
                  ...
                  {address && (
                    <div className="flex justify-center mt-3">
                      <button className="flex items-center justify-between w-full px-5 py-3   bg-white hover:bg-gray-50 text-[#38572e] border-[0.25px] border-[#38572e] shadow rounded-lg max-w-md">
                        <div className="flex items-center space-x-6">
                          <img
                            src={addressImg}
                            alt="Address"
                ...
                {services != "" && (
                  <div className="px-4 ">
                    ...
                    {services && (
                      <div className="flex justify-center mt-2 w-full px-5 py-3 bg   bg-white hover:bg-gray-50 text-[#38572e] border-[0.25px] border-[#38572e] shadow rounded-lg max-w-md">
