  ...
  if (client) {
    return (
      <div>
        {show && (
          <div
            className="qr-modal min-h-screen w-full max-w-md mx-auto shadow-lg flex flex-col justify-center items-center mx-2 relative bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800"
                  ...
                  <a href={logo}>
                    <div className="relative mb-2 ">
                      <img
                        src={logo}
                        alt="profile"
                        className="w-[10rem] h-[10rem] mx-auto rounded-[50%] border-[2px] border-white shadow-md"
                      />
                    </div>
                  </a>
                </div>
            ...
            >
              ...
              <div className="px-6">
                {phone01 && (
                  <div className="flex justify-center mt-3">
                    <a className="flex items-center justify-between w-full px-4 py-4  bg-white hover:bg-gray-50 text-[#231f20] border-[0.25px] border-[#38572e] shadow rounded-lg max-w-md gap-x-2">
                      {/* Phone Icon and Info */}
                ...
                {phone02 && (
                  <div className="flex justify-center mt-3">
                    <a className="lex items-center justify-between w-full px-4 py-4  bg-white hover:bg-gray-50 text-[#231f20] border-[0.25px] border-[#38572e] shadow rounded-lg max-w-md gap-x-2">
                      {/* Phone Icon and Info */}
                      <div className="flex items-center space-x-3 w-full">
                ...
                {email && (
                  <div className="flex justify-center mt-3 ">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between w-full px-3 py-3 bg-white hover:bg-gray-50 text-[#231f20] border-[0.25px] border-[#38572e] shadow rounded-lg max-w-md"
                    >
                ...
                {email02 && (
                  <div className="flex justify-center mt-3">
                    <a className="flex w-full px-3 py-3  bg-white hover:bg-gray-50 text-[#231f20] border-[0.25px] border-[#38572e] shadow rounded-lg max-w-md">
                      {/* Phone Icon and Info */}
                      <div className="flex items-center space-x-3 w-full">
                        <img
                          src={emailImg}
                ...
                {(phone01 == "" ||
                  ...
                  profileLink02 == "") && (
                  <div
                    className="flex items-center  cursor-pointer  bg-white hover:bg-gray-50 text-[#231f20] border-[0.25px] border-black mx-auto rounded-lg shadow-md px-4 py-2 mt-3 gap-x-2"
              ...
              <div className="px-6">
                <div className="">
                  ...
                  {img01 && (
                    <div className="flex flex-col items-center bg-[#231f20]  hover:bg-[#4f7b41] mx-auto rounded-xl border-[0.25px] border-white shadow-md space-y-2 mt-3 pb-2">
                      <a href={img01}>
                        <img
                          src={img01}
                          alt="Image"
                  ...
                  {img02 && (
                    <div className="flex flex-col items-center bg-[#231f20]  hover:bg-[#4f7b41]  border-[0.5px] border-white mx-auto rounded-xl border-[0.25px] border-white shadow-md space-y-2 mt-3 pb-2">
                      <a href={img02}>
                        <img
                          src={img02}
                          alt="Image"
                  ...
                  {(img01 == "" ||
                    ...
                    img10 == "") && (
                    <div
                      className="flex items-center  cursor-pointer  bg-white hover:bg-gray-50 text-black border-[0.25px] border-black mx-auto rounded-lg shadow-md px-4 py-2 mt-3 gap-x-2"
        ...
        {show02 && (
          <div
            className={`min-h-screen pt-2 w-full max-w-md mx-auto flex justify-center items-center mx-2 shadow-lg pb-5 text-center bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800`}
            style={{ backgroundAttachment: "fixed" }}
          >
            <div className="bg-white border-gray-500 rounded-lg pb-8 pt-16 px-10 relative">
              {/* Close Icon */}
        ...
        {show03 && (
          <div
            className={`min-h-screen flex justify-center items-center mx-2 pt-2 w-full max-w-md mx-auto shadow-lg pb-5 text-center bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800`}
            style={{ backgroundAttachment: "fixed" }}
          >
            <div className="bg-white border-gray-500 rounded-lg pb-8 pt-16 px-10 relative">
              {/* Close Icon */}
