      ...
      <div className="mx-auto max-w-[430px] rounded-[22px] bg-white/45 p-[3px] shadow-[0_10px_28px_rgba(88,45,20,0.16)]">
        <article className="relative overflow-hidden rounded-[22px] border border-white bg-[#fffaf3] px-3 py-5 text-center shadow-[inset_0_0_0_1px_rgba(232,205,167,0.55)]">
          ...
          <div className="relative z-10 pt-14">
            ...
            <div className="mt-3 py-2 overflow-hidden rounded-[14px] border border-[#ead9c9] bg-[#fffdf8] shadow-[0_4px_14px_rgba(106,57,28,0.1)]">
              <ContactRow
            ...
            {googleReviewLink ? (
              <a
                ...
                className="mt-3 flex items-center gap-3 rounded-[16px] border border-[#ead9c9] bg-[#fffdf8] px-4 py-5 text-left shadow-[0_5px_16px_rgba(106,57,28,0.12)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_9px_22px_rgba(106,57,28,0.18)]"
              >
