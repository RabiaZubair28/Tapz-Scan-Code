...
>
        ...
        return(
            ...
            <div className={`min-h-screen w-full max-w-md mx-auto shadow-lg pt-5 pb-5 text-center flex justify-center align-center bg-gradient-to-tr from-[#ffb8d6] via-[#f9d6cd] to-[#f6ece9] mt-[30%]`} style={{ backgroundAttachment: "fixed" }}>
            <ScaleLoader
            color={"black"}
            size={50}
