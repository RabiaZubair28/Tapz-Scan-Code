        ...
        <div>
                    ...
                    {logo && (
                      ...
                      >
                        <img
                          src={logo}
                          alt="logo"
                          className="w-36 h-36 object-cover rounded-2xl border-[1px] border-black bg-white shadow-lg"
                        />
                      </a>
                    )}
                  </div>
          ...
          <p>{visitCount}</p>
                  ...
                  {menuLink && (
                    <div className="flex justify-center mt-3">
                      <button
                        className="flex items-center justify-between w-full px-5 py-3  bg-white text-black border-[0.25px] rounded-lg border-black shadow  max-w-md"
