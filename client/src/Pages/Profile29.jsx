              ...
              <a href={logo}>
                <div className="relative mb-2 ">
                  <img
                    src={logo}
                    alt="profile"
                    className="w-[10rem] h-[10rem] mx-auto rounded-[50%] border-[2px] border-black shadow-md"
                  />
                </div>
              </a>
            </div>
          ...
          <div className="px-6">
            ...
            <div className="px-0 mt-4 flex gap-2 flex-nowrap">
              ...
              >
                ...
                <span className="ml-1 text-[12px] whitespace-nowrap">
                  Lusail
                </span>
              </a>
            ...
            {telephone02 && (
              <div className="flex justify-center mt-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between w-full px-5 py-3  bg-black hover:bg-black text-white border-[0.25px] border-white shadow rounded-lg max-w-md"
                >
            ...
            {menuLink && (
              <div className="flex justify-center mt-3">
                <button
                  className="flex items-center justify-between w-full px-5 py-3  bg-black hover:bg-black text-white border-[0.25px] border-white shadow rounded-lg max-w-md gap-x-2"
            ...
            {profileLink01 && (
              <div className="flex justify-center mt-3">
                <button
                  className="flex items-center justify-between w-full px-4 py-4  bg-black hover:bg-black text-white border-[0.25px] border-white shadow rounded-lg max-w-md gap-x-2"
          ...
          <div className="px-6">
            {(img01 != "" ||
              ...
              <div className="px-0">
                ...
                {img01 && (
                  <div className="flex flex-col items-center bg-white mx-auto rounded-xl border-[0.25px] border-black shadow-md space-y-2 mt-3">
                    <a href={img01}>
                      <img
                        src={img01}
                        alt="Image"
            ...
            {/* {location != "" && (
              <div className="px-0">
                ...
                <div className="flex flex-col items-center bg-black mx-auto rounded-xl border-[1px] border-black shadow-md  space-y-4 mt-3">
                  {location && (
                    <iframe
                      src={location}
                      width="100%"
