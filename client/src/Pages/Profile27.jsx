                ...
                <div className="flex flex-col gap-4">
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        <div className="w-12 h-12 flex items-center justify-center text-white">
                          <img src={websiteImg} alt="Website" className="w-10 h-10" />
                        </div>
                  ...
                  {profileLink01 && (
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        <div className="w-12 h-12 flex items-center justify-center text-white">
                          <img src={profile} alt="Services" className="w-10 h-10" />
                        </div>
                        <div className="min-w-0 text-left">
                          <p className="text-white font-semibold truncate">
                  ...
                  {catalogueLink && (
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        <div className="w-12 h-12 flex items-center justify-center text-white">
                          <img src={catalog} alt="Boutiqaat" className="w-10 h-10" />
                        </div>
                        <div className="min-w-0 text-left">
                          <p className="text-white font-semibold truncate">
                  ...
                  {tiktokLink && (
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0 text-left">
                          <p className="text-white font-semibold truncate">Tik Tok</p>
                          <p className="text-white/80 text-sm truncate" dir="rtl">
                            تيك توك
                          </p>
                        </div>
                  ...
                  {instagramLink && (
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0 text-left">
                          <p className="text-white font-semibold truncate">Instagram</p>
                          <p className="text-white/80 text-sm truncate" dir="rtl">
                            انستغرام
                          </p>
                        </div>
