        ...
        <div>
          ...
          {!show && !show02 && (
            ...
            ()=>{
              ...
              <div
                className={`min-h-screen w-full max-w-md mx-auto shadow-lg pt-5 pb-5 text-center bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800`}
                style={{ backgroundAttachment: "fixed" }}
              >
                {logo && (
          ...
          <p>{visitCount}</p>
                  ...
                  <div className="flex items-center justify-center mt-2 mb-7">
                    ...
                    <button className="flex items-center justify-center gap-x-2 rounded-lg py-2 px-10  bg-gray-600 hover:bg-gray-500 border-white border-[0.25px] shadow-sm hover:shadow-md text-white">
                      <FaDownload
                        size={20}
