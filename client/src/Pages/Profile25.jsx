        ...
        <div>
          ...
          <p>{visitCount}</p>
                  ...
                  <div className="flex items-center justify-center mt-3 mb-7">
                    ...
                    <button className="flex items-center justify-center gap-x-2 rounded-md py-2 px-10  bg-white border-white border-[0.25px] shadow-sm hover:shadow-md text-black">
                      <FaDownload
                        size={20}
