        ...
        <div>
          ...
          {!show && !show02 && (
            ...
            ()=>{
              ...
              <div
                className={`min-h-screen w-full max-w-md mx-auto shadow-lg pt-5 pb-5 text-center bg-black`}
                style={{ backgroundAttachment: "fixed" }}
              >
                {logo && (
                    ...
                    <a href={logo}>
                      <div className="relative mb-2 ">
                        <img
                          src={logo}
                          alt="profile"
                          className="w-48 h-48 mx-auto rounded-full border-[5px] border-gray-50 shadow-md"
                        />
                      </div>
                    </a>
                  </div>
                ...
                <div className="px-6">
                  <div className="flex flex-col justify-center items-center pt-0.5">
                    ...
                    <h2 className="text-2xl text-center font-semibold text-white pt-1">
                      {clientName}
                    </h2>
                    <p className="text-md text-center font-semibold text-white pt-1 pb-1">
                      {designation}
                    </p>
                  </div>
          ...
          <p>{visitCount}</p>
                  ...
                  <div className="flex items-center justify-center mt-2 mb-7">
                    ...
                    <button className="flex items-center justify-center gap-x-2 rounded-sm py-2 px-10  bg-gray-600 hover:bg-gray-500 border-white border-[0.25px] shadow-sm hover:shadow-md text-white">
                      <FaDownload
                        size={20}
                  ...
                  {phone01 && (
                    <div className="flex justify-center mt-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between w-full px-5 py-3 bg-white text-black border-[0.25px] border-white shadow rounded-lg max-w-md"
                      >
                  ...
                  {address && (
                    <div className="flex justify-center mt-3">
                      <button className="flex items-center justify-between w-full px-5 py-3  bg-white text-black border-[0.25px] border-white shadow rounded-lg max-w-md">
                        <div className="flex items-center space-x-6">
                          <img
                            src={addressImg}
                            alt="Address"
                ...
                <div className="px-4">
                  ...
                  <div className="flex justify-center space-x-3 mt-3 px-4">
                    <div
                      className=" flex justify-center items-center w-16 h-16 rounded-full border-[0.25px] border-white bg-white hover:border-white"
                      onClick={handleShow}
                    >
