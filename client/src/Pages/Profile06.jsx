...
// Used it for a Client make it dynamic by fetching the current client id
  ...
  {      return( <section>
    ...
    <div className={`min-h-screen pt-8 w-full max-w-md mx-auto shadow-lg pb-5 text-center bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800`} style={{ backgroundAttachment: "fixed" }}>
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col text-start">
            <span className="text-lg font-semibold">{profileName01}</span>
          </div>
        </div>
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col text-start">
            ...
            <span className="text-lg font-semibold">{profileName02}</span>
          </div>
        </div>
        {/* <SlArrowRight  /> Chevron/Arrow */}
      </button>
