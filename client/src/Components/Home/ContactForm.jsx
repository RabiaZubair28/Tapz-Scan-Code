...
const ContactForm = ({ onClose }) => {
  ...
  return (
    <div>
      {
        contactModal && (<div className="fixed inset-0 bg-blue-50 bg-opacity-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex flex-col space-y-4">
          <div className="w-full">
            ...
            /> */}
            <h2 className="text-3xl font-bold text-[#1a237e] text-center mb-4">Connect With Us!</h2>
          </div>
